...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-border-subtle bg-surface-container/80 backdrop-blur-lg">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
            ...
            <Link
              ...
              className={clsx(
                ...
                isActive(item.href)
                  ...
                  : "text-text-secondary hover:bg-surface-highest/50 hover:text-text-primary"
              )}
            >
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/session/new"
            className="ml-2 flex items-center gap-1.5 rounded-lg bg-primary-container px-3 py-1.5 text-sm font-medium text-text-primary transition hover:bg-primary-container/80 hover:shadow-glow"
          >
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg text-text-secondary sm:hidden"
          >
            {mobileOpen ? (
              <X className="h-5 w-5" />
            ) : (
      ...
      {mobileOpen && (
        <div className="border-t border-border-subtle px-4 pb-4 sm:hidden">
          <div className="mt-2 space-y-1">
            ...
            <button
              onClick={() => signOut({ callbackUrl: "/" })}
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-text-secondary transition hover:bg-surface-highest/50 hover:text-text-primary"
            >
              <LogOut className="h-4 w-4" />
              {t('signOut')}
            </button>
